...
for nome_do_restaurante, dados in dados_restaurante.items():
    ...
    with open(nome_do_arquivo, "w") as arquivo_restaraunte:
        # Pega a lista de pratos e escreve dentro do arquivo no formato JSON. O indent=4 serve para o arquivo ficar "bonitinho" e legível para humanos, com espaços e quebras de linha.
        json.dump(dados, arquivo_restaraunte, indent=4)
