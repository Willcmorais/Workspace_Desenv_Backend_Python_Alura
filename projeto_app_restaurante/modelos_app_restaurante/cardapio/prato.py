...
# Para indicar que essa classe é um "filho(a)" da classe mãe colocaremos a classe mãe sendo referenciada dentro de parênteses. Isso quer dizer que a classe Prato vai poder utilizar todas as classes e atributos da classe mãe.
